/* ================================================================
   GALAXY BACKGROUND — optimized for Android
================================================================ */
(function() {
  const canvas = document.getElementById('galaxy-canvas');
  const ctx = canvas.getContext('2d');
  let W, H, dpr;
  // Detect low-performance device (Android)
  const isLowPerf = /Android/i.test(navigator.userAgent);
...
/* ================================================================
   PARALLAX HERO — disabled on Android/mobile for perf
================================================================ */
